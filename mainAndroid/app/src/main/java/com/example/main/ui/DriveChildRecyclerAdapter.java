...
//recycle list under the parent one that shows pending requests
public class DriveChildRecyclerAdapter extends RecyclerView.Adapter<DriveChildRecyclerAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public DriveChildRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.child_layout,parent,false);
        DriveChildRecyclerAdapter.ViewHolder holder = new DriveChildRecyclerAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull DriveChildRecyclerAdapter.ViewHolder holder, int position) {
        String a,c;
